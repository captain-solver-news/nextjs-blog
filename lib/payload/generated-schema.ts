...
export const posts = pgTable(
  'posts',
  {
    ...
    contentUpdatedAt: timestamp('content_updated_at', { mode: 'string', withTimezone: true, precision: 3 }),
  ...
  (columns) => [
    ...
    index('posts_published_at_idx').on(columns.publishedAt),
    index('posts_content_updated_at_idx').on(columns.contentUpdatedAt),
